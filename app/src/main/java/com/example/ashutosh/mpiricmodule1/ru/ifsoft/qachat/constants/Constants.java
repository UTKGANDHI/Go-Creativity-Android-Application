package com.example.ashutosh.mpiricmodule1.ru.ifsoft.qachat.constants;
...
public interface Constants {
    ...
    public static final String API_DOMAIN = "http://chat.tallyvm.co.in/";  //url address to which the application sends requests
