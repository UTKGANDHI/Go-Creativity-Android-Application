...
public class Versatile_logo extends AppCompatActivity implements  AsyncRequest.OnAsyncRequestComplete{
  ...
  ArrayList<String> filter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_versatile_logo);
...
//        initCollapsingToolbar();
     ...
     /*   Buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buydialog(Versatile_logo.this, getApplicationContext(),"Confirm Item" , "Name: "+itemname+"\n"+"Price: "+"$"+s ,pr,productid,itemname);
                buyflag=true;
            }
        });*/
        ...
        String Image ="http://cdn.wccftech.com/wp-content/uploads/2014/10/15.jpg";
        try {
   ...
   /* private void initCollapsingToolbar() {
    ...
    public void expandableButton1(View view) {
        Intent i = new Intent(Versatile_logo.this,Details.class);
        startActivity(i);
    }
    ...
    public void SortAscending(String response1, String index)
    {
        ...
        try{
            ...
            for(int i=0;i<object1.length();i++)
            {
                ...
                mycard.setType(type);mycard.setUrl(url);
                if(DesignArray1.isEmpty()){
    ...
    public void openSortDialog() {
        ...
        alertDialog = new AlertDialog.Builder(Versatile_logo.this).create();
