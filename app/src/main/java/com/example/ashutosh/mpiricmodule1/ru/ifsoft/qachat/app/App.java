package com.example.ashutosh.mpiricmodule1.ru.ifsoft.qachat.app;
...
import com.example.ashutosh.mpiricmodule1.ru.ifsoft.qachat.util.GPSTracker;
import com.example.ashutosh.mpiricmodule1.ru.ifsoft.qachat.util.LruBitmapCache;
...
public class App extends Application implements Constants {
    ...
    private long id;
    private int state, admob, verify, allowMessages, allowFollowersGCM, allowMessagesGCM, errorCode, currentChatId = 0, notificationsCount = 0, messagesCount = 0, newFriendsCount = 0;
