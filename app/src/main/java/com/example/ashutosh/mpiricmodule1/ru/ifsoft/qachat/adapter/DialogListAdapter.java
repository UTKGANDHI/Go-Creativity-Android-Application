...
import com.example.ashutosh.mpiricmodule1.ru.ifsoft.qachat.ProfileActivity;
import com.pkmmte.view.CircularImageView;

import java.util.List;

import com.example.ashutosh.mpiricmodule1.github.ankushsachdeva.emojicon.EmojiconTextView;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // viewHolder.chatOpponent.setTag(R.id.notifyAuthor, viewHolder);
        ...
        viewHolder.chatOpponentFullname.setText(chat.getWithUserFullname());
            //viewHolder.chatOpponentFullname.setText("Customer Support");
