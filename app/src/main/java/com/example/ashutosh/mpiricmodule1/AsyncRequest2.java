...
/**
 * Created by Ashutosh on 03-04-2017.
 */
...
public class AsyncRequest2 extends AsyncTask<String, Integer, String> {
    ...
    // Three Constructors
    public AsyncRequest2(Activity a, String m, List<NameValuePair> p) {
    ...
    public AsyncRequest2(Context a, String m) {
        context = a;
        caller = (OnAsyncRequestComplete) a;
    ...
    public AsyncRequest2(Activity a) {
        caller = (OnAsyncRequestComplete) a;
        context = a;
    }
    public AsyncRequest2(Context a, String method, OnAsyncRequestComplete caller)
    {
        this.caller = caller;
        context = a;
