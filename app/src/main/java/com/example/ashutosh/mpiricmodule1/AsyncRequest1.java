...
public class AsyncRequest1 extends AsyncTask<String, Integer, String> {
    ...
    // Three Constructors
    public AsyncRequest1(Activity a, String m, List<NameValuePair> p) {
    ...
    public AsyncRequest1(Context a, String m) {
        context = a;
        caller = (OnAsyncRequestComplete) a;
    ...
    public AsyncRequest1(Activity a) {
        caller = (OnAsyncRequestComplete) a;
        context = a;
    }
    public AsyncRequest1(Context a, String method, OnAsyncRequestComplete caller)
    {
        this.caller = caller;
        context = a;
