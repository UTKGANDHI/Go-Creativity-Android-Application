...
public class LoginFragment extends Fragment implements Constants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SharedPreferences sh1=getActivity().getSharedPreferences("LoginAuth", Context.MODE_PRIVATE);

//          Toast.makeText(getActivity().getApplicationContext(),sh1.getString("USERNAME",null),Toast.LENGTH_LONG).show();
    //    Toast.makeText(getActivity().getApplicationContext(),"hello chat",Toast.LENGTH_LONG).show();

        username = sh1.getString("USERNAME",null);
       // username="newutk8";
        password = "7600918012";
        signin();
